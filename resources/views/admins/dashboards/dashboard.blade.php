            ...
            <div class="col-md-12 col-lg-12 col-xl-7">
                <div class="card">
                    <div class="card-header bg-transparent pd-b-0 pd-t-20 bd-b-0">
                        ...
                        <p class="tx-12 text-muted mb-0">Order Status and Tracking. Track your order from ship date
                        ...
                        <div class="list-group list-lg-group list-group-flush">
                            <div class="list-group-item list-group-item-action" href="#">
                                <div class="media mt-0">
                                    <img class="avatar-lg rounded-circle my-auto me-3" src="../../assets/img/faces/3.jpg"
                            ...
                            <div class="list-group-item list-group-item-action br-t-1" href="#">
                                <div class="media mt-0">
                                    <img class="avatar-lg rounded-circle my-auto me-3" src="../../assets/img/faces/11.jpg"
                                        alt="Image description">
                                    <div class="media-body">
                                        <div class="d-flex align-items-center">
                                            <div class="mt-1">
                            ...
                            <div class="list-group-item list-group-item-action br-t-1" href="#">
                                <div class="media mt-0">
                                    <img class="avatar-lg rounded-circle my-auto me-3" src="../../assets/img/faces/17.jpg"
                                        alt="Image description">
                                    <div class="media-body">
                                        <div class="d-flex align-items-center">
                                            <div class="mt-1">
                            ...
                            <div class="list-group-item list-group-item-action br-t-1" href="#">
                                <div class="media mt-0">
                                    <img class="avatar-lg rounded-circle my-auto me-3" src="../../assets/img/faces/15.jpg"
                                        alt="Image description">
                                    <div class="media-body">
                                        <div class="d-flex align-items-center">
                                            <div class="mt-1">
                            ...
                            <div class="list-group-item list-group-item-action br-t-1 br-br-7 br-bl-7" href="#">
                                <div class="media mt-0">
                                    <img class="avatar-lg rounded-circle my-auto me-3" src="../../assets/img/faces/6.jpg"
                                        alt="Image description">
                                    <div class="media-body">
                                        <div class="d-flex align-items-center">
                                            <div class="mt-1">
                    ...
                    <div class="product-timeline card-body pt-2 mt-1">
                        <ul class="timeline-1 mb-0">
                            ...
                            <li class="mt-0" id="mrg-8"> <i
                                    ...
                                    class="fw-semibold mb-4 tx-14 ">Toatal Revenue</span> <a href="#"
                            ...
                            <li class="mt-0 mb-0" id="mrg-8"> <i
                                    ...
                                    class="fw-semibold mb-4 tx-14 ">Customer Reviews</span> <a href="#"
                                    class="float-end tx-11 text-muted">1 day ago</a>
                    ...
                    <div class="card-body sales-info ot-0 pb-0 pt-0">
                        ...
                        <div class="row sales-infomation pb-0 mb-0 mx-auto wd-100p">
                            <div class="col-md-6 col">
                                <p class="mb-0 d-flex"><span class="legend bg-primary brround"></span>Delivered
                                </p>
